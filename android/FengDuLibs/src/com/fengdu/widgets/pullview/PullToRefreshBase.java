 ...
 *******************************************************************************/
package com.fengdu.widgets.pullview;

import com.fengdu.R;
import com.fengdu.widgets.pullview.internal.FlipLoadingLayout;
import com.fengdu.widgets.pullview.internal.LoadingLayout;
import com.fengdu.widgets.pullview.internal.RotateLoadingLayout;
import com.fengdu.widgets.pullview.internal.Utils;
import com.fengdu.widgets.pullview.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static enum Mode {
		...
		// The modeInt values need to match those from ptr_attrs.xml
		Mode(int modeInt) {
			mIntValue = modeInt;
		}
